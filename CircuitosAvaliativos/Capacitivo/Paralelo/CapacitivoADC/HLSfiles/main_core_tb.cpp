...
int main(){
	...
	FILE *fp;
	fp = fopen("C:\\Users\\rodrigobagdadi\\Desktop\\RealTime\\ProjetoPipelineHLS\\CircuitosAvaliativos\\Capacitivo\\Paralelo\\CapacitivoADC\\results_CapacitivoParaleloADC.txt", "w");
	std::string perm;
