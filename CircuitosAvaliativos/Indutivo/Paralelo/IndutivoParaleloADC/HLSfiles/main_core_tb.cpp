...
int main(){
	...
	FILE *fp;
	fp = fopen("C:\\Users\\rodrigobagdadi\\Desktop\\RealTime\\ProjetoPipelineHLS\\CircuitosAvaliativos\\Indutivo\\Paralelo\\IndutivoParaleloADC\\results_IndutivoParaleloADC.txt", "w");
	std::string perm;
