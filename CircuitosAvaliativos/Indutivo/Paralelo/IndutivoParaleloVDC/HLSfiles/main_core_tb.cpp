...
int main(){
	...
	FILE *fp;
	fp = fopen("C:\\Users\\rodrigobagdadi\\Desktop\\RealTime\\ProjetoPipelineHLS\\CircuitosAvaliativos\\Indutivo\\Paralelo\\IndutivoParaleloVDC\\results_IndutivoParaleloVDC.txt", "w");
	std::string perm;
