...
int main(){
	...
	FILE *fp;
	fp = fopen("C:\\Users\\rodrigobagdadi\\Desktop\\RealTime\\ProjetoPipelineHLS\\CircuitosAvaliativos\\Indutivo\\Paralelo\\IndutivoParaleloVAC\\results_IndutivoParaleloVAC.txt", "w");
	std::string perm;
