...
int main(){
	...
	FILE *fp;
	fp = fopen("C:\\Users\\rodrigobagdadi\\Desktop\\RealTime\\ProjetoPipelineHLS\\CircuitosAvaliativos\\Indutivo\\Serie\\IndutivoSerieVAC\\results_IndutivoSerieVAC.txt", "w");
	std::string perm;
